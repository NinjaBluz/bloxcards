local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["DDude"] = {
		...
		["Effect"] = {
			Name = "Vampire",
			Description = "Whenever you gain life, add a kill script into your hand.",
			["Type"] = "OnHealthGain",
	...
	["PencilWizard"] = {
		...
		["Effect"] = {
			Name = "AAAAAAAAAAAAAAAAAA",
			Description = "Deal 400 damage to all other yellow fighters.",
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",9999,"Self"},{"Damage",9999}},
			Target = "ColorYellow",
		},
	...
	["litozinnamon"] = {
		...
		["Effect"] = {
			Name = "AAAAAAAAAAAAAAAAAA",
			Description = "Deal 150 damage to one fighter, then lock it for 1 turn.",
			["Type"] = "OnSummon",
			["Power"] = {{"Lock",1},{"Damage",150}},
			Target = "Single",
		},
		["Bio"] = "Ice cold.",
	},
